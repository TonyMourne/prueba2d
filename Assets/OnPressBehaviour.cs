...
public class OnPressBehaviour : MonoBehaviour
{
...
- NOMBRE_Y_APELLIDOS (Pon el nombre solamente y sin descripción adicional en este apartado)
- MOTES
- EDAD
- RAZA
- DESCRIPCIÓN_FÍSICA_DETALLADA
- DESCRIPCIÓN_PSICOLÓGICA_DETALLADA
- MORAL
- CREENCIAS
- HISTORIA_PERSONAL
- NIVEL
- HABILIDADES
- EQUIPAMIENTO_Y_PERTENENCIAS  
...
";
    ...
    IEnumerator SendMessageToOpenAI()
    {
        ...
        while (!finished && loopactual <= MaxLoops && !cancelRequested)
        {
            ...
            if (aiResponse.Contains("27012004_LAST_MESSAGE"))
            {
                ...
                string tituloPersonaje = secciones.ContainsKey("NOMBRE_Y_APELLIDOS") ? secciones["NOMBRE_Y_APELLIDOS"].Trim() : "SinTitulo";
                Debug.Log("nombre de personaje es: "+tituloPersonaje);
                ...
                GPE.ReloadYSeleccionarPorTitulo(tituloPersonaje, "P");
    ...
    {
        string url = "http://localhost:8080/api/personajes";
        ...
        {
            Debug.Log("Personaje enviado correctamente a la base de datos");
        }
    }
